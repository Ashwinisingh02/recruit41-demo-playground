...
export default {
	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				sans: ['Inter', 'ui-sans-serif', 'system-ui', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'Noto Sans', 'Apple Color Emoji', 'Noto Color Emoji'],
			...
			animation: {
				...
				'fade-out': 'fade-out 0.35s ease-out both',
